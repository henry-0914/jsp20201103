...
SELECT * FORM employee WHERE salary >=3000;
SELECT * FROM employee WHERE salary <=2000;
SELECT * FROM employee WHERE ename <= 'G'; -- 문자는 작은 따옴표만 사용 --
SELECT * FROM employee WHERE ename != 'SMITH';
SELECT * FROM employee WHERE ename <> 'SMITH';
SELECT * FROM employee WHERE ename ^= 'SMITH';
SELECT * FROM employee WHERE hiredate = '1991/02/20';
...
WHERE ename > 'A' AND salary > 3000 AND dno <> 30;
